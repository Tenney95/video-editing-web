...
export const themeSettings: App.Theme.ThemeSetting = {
  ...
  layout: { mode: 'vertical-mix', scrollMode: 'content', reverseHorizontalMix: false },
  page: { animate: true, animateMode: 'fade-slide' },
  header: { height: 46, breadcrumb: { visible: true, showIcon: true } },
  ...
  watermark: { visible: false, text: 'DreamDrawingAi' },
  tokens: {
    light: {
      colors: {
